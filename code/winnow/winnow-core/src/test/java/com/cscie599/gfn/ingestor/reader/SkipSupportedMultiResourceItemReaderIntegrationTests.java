...
/**
 * Copied from https://raw.githubusercontent.com/spring-projects/spring-batch/master/spring-batch-infrastructure/src/test/java/org/springframework/batch/item/file/MultiResourceItemReaderIntegrationTests.java
 * added tests having *skip*
 * Tests for {@link SkipSupportedMultiResourceItemReader}.
 */
public class SkipSupportedMultiResourceItemReaderIntegrationTests {

    private SkipSupportedMultiResourceItemReader<String> tested = new SkipSupportedMultiResourceItemReader<>();
     ...
     */
    @Test
    public void testReadSkip5() throws Exception {
    ...
    @Test
    public void testGetCurrentResourceSkip5() throws Exception {
        tested.setLinesToSkip(5);
        tested.open(ctx);
        assertEquals("6", tested.read());
        assertSame(r4, tested.getCurrentResource());
