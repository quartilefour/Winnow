...
public class IngestionTest extends BaseTest {
    ...
    public void testRawIngestion() throws Exception {
        ...
        assertEquals(" Date revised for meshTerm", new Date(1341298800000L),meshtermList.get(0).getDateRevised());
        ...
        assertEquals(new Date(915177600000L),meshtermTree.getMeshterm().getDateCreated());
        assertEquals(new Date(1520838000000L),meshtermTree.getMeshterm().getDateRevised());
