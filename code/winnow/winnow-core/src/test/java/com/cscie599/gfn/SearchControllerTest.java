...
public class SearchControllerTest extends BaseTest {
    ...
    public void testExecuteSearchWithGeneIds() throws JSONException {
        ...
        String expectedResponse = "{\"searchQuery\":{\"symbol\":[],\"geneId\":[\"1246505\"],\"meshTreeId\":[],\"name\":[],\"description\":[],\"meshId\":[]},\"results\":[{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D000818\",\"name\":\"Animals\",\"publicationCount\":13,\"pvalue\":0.001},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.0488},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003201\",\"name\":\"Computers\",\"publicationCount\":1,\"pvalue\":0.5433}]}";
    ...
    public void testExecuteSearchWithMeshIds() throws JSONException {
        ...
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        logger.info("Response Body: \"" + response.getBody() + "\"");
        String expectedResponse = "{\"searchQuery\":{\"symbol\":[],\"geneId\":[],\"meshTreeId\":[],\"name\":[],\"description\":[],\"meshId\":[\"D003063\"]},\"results\":[{\"geneId\":\"8655732\",\"description\":\"3-isopropylmalate dehydratase large subunit; leucine biosinthesis\",\"symbol\":\"leuC\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":0,\"pvalue\":0.0095},{\"geneId\":\"5692769\",\"description\":\"Record to support submission of GeneRIFs for a gene not in Gene (Azotirhizobium caulinodans.  Use when strain, subtype, isolate, etc. is unspecified, or when different from all specified ones in Gene.).\",\"symbol\":\"NEWENTRY\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.045},{\"geneId\":\"8458\",\"description\":\"transcription termination factor 2\",\"symbol\":\"TTF2\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":10,\"pvalue\":0.0478},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.0488},{\"geneId\":\"8520\",\"description\":\"histone acetyltransferase 1\",\"symbol\":\"HAT1\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":2,\"pvalue\":0.099}]}";
        assertEquals(expectedResponse, response.getBody());
    }
    ...
    public void testExecuteSearchWithGenes() throws JSONException {
        ...
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        logger.info("Response Body: \"" + response.getBody() + "\"");
        String expectedResponse = "{\"searchQuery\":{\"symbol\":[\"leuD\"],\"geneId\":[\"1246505\"],\"meshTreeId\":[],\"name\":[],\"description\":[\"isopropylmalate isomerase small subunit\"],\"meshId\":[]},\"results\":[{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D000818\",\"name\":\"Animals\",\"publicationCount\":13,\"pvalue\":0.001},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.0488},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003201\",\"name\":\"Computers\",\"publicationCount\":1,\"pvalue\":0.5433}]}";
        assertEquals(expectedResponse, response.getBody());
    }
    ...
    public void testExecuteSearchWithMeshterms() throws JSONException {
        ...
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        logger.info("Response Body: \"" + response.getBody() + "\"");
        String expectedResponse = "{\"searchQuery\":{\"symbol\":[],\"geneId\":[],\"meshTreeId\":[\"B01.050.500.308\"],\"name\":[\"Cnidaria\"],\"description\":[],\"meshId\":[\"D003063\"]},\"results\":[{\"geneId\":\"8655732\",\"description\":\"3-isopropylmalate dehydratase large subunit; leucine biosinthesis\",\"symbol\":\"leuC\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":0,\"pvalue\":0.0095},{\"geneId\":\"5692769\",\"description\":\"Record to support submission of GeneRIFs for a gene not in Gene (Azotirhizobium caulinodans.  Use when strain, subtype, isolate, etc. is unspecified, or when different from all specified ones in Gene.).\",\"symbol\":\"NEWENTRY\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.045},{\"geneId\":\"8458\",\"description\":\"transcription termination factor 2\",\"symbol\":\"TTF2\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":10,\"pvalue\":0.0478},{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.0488},{\"geneId\":\"8520\",\"description\":\"histone acetyltransferase 1\",\"symbol\":\"HAT1\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":2,\"pvalue\":0.099}]}";
        assertEquals(expectedResponse, response.getBody());
    }
    ...
    public void testExecuteSearchWithGenesAndMeshterms() throws JSONException {
        ...
        assertEquals(response.getStatusCode(), HttpStatus.OK);
        logger.info("Response Body: \"" + response.getBody() + "\"");
        String expectedResponse = "{\"searchQuery\":{\"symbol\":[\"leuD\"],\"geneId\":[\"1246505\"],\"meshTreeId\":[\"B01.050.500.308\"],\"name\":[\"Cnidaria\"],\"description\":[\"isopropylmalate isomerase small subunit\"],\"meshId\":[\"D003063\"]},\"results\":[{\"geneId\":\"1246505\",\"description\":\"isopropylmalate isomerase small subunit\",\"symbol\":\"leuD\",\"meshId\":\"D003063\",\"name\":\"Cnidaria\",\"publicationCount\":11,\"pvalue\":0.0488}]}";
        assertEquals(expectedResponse, response.getBody());
    }
