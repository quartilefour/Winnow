...
public class GeneMeshIngestor {
    ...
    @Bean
    public ItemProcessor<GenePublicationPK, GenePublicationPK> processorForGeneMeshterm() {
        return new GeneMeshtermIngester.DBLogProcessor();
    }
